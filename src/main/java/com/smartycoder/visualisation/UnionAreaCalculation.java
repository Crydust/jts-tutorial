 ...
 *
 */
public class UnionAreaCalculation {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				JFrame frame = new JFrame("JTS Visualisation - Union Area Calculation");
				...
				panel.addDrawCommand(new DrawingCommand() {
					...
					public void doDrawing(Graphics g) {
						...
						g.drawString("The polygon calculated by unioning two polygons.", 60, 330);

	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				JFrame frame = new JFrame("JTS Visualisation - Douglas Peucker Geometry Simplification");
				...
				panel.addDrawCommand(new DrawingCommand() {
					...
					public void doDrawing(Graphics g) {
						...
						coords = simplerLineString.getCoordinates();
						...
						g.drawString("simplified line coordinate size " + simplerLineString.getNumPoints(), 60, 330);
					}
				});
